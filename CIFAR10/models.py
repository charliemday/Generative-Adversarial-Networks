...
filenames = glob.glob("MNIST/images/*.png")
images = []
for file in filenames:
    images.append(imageio.imread(file))

imageio.mimsave("MNIST/mnist.gif", images, fps = 2)

#
# with imageio.get_writer("cifar10.gif", mode = "I") as writer:
#     filenames = glob.glob("CIFAR10/images/*.png")
